macro(setup_mdk)
  ...
  if("$ENV{MDK_SDK_URL}" MATCHES "^http") # github release: https://github.com/wang-bin/mdk-sdk/releases/latest/download
    set(MDK_SDK_URL $ENV{MDK_SDK_URL}) # TODO: md5
  else()
    set(MDK_SDK_URL https://sourceforge.net/projects/mdk-sdk/files/nightly)
  endif()
  set(MDK_SDK_URL ${MDK_SDK_URL}/${MDK_SDK_PKG})
  set(MDK_SDK_SAVE "${CMAKE_CURRENT_SOURCE_DIR}/${MDK_SDK_PKG}")

  set(DOWNLOAD_MDK_SDK OFF)
  message("MDK_SDK_LATEST=$ENV{MDK_SDK_LATEST}")
  # TODO: download from github option MDK_SDK_LATEST_RELEASE=1
  if($ENV{MDK_SDK_LATEST})
